...
async function fetchPictures () {
    ...
    let responseGiphy = await fetch (`https://api.giphy.com/v1/gifs/search?api_key=${GIPY_API_KEY}&q=${searchTerm}&limit=25&offset=0&rating=g&lang=en&bundle=messaging_non_clips`)
